...
import com.anordine.completions.api.webflux.util.InternalSpringUtils;
import com.anordine.completions.api.webflux.util.InternalStringUtils;
...
public final class CustomWebClientBeanFactoryPostProcessor
    ...
    private Map<String, WebClientProperties.CustomClient> bindCustomClientsProperties() {
        return InternalSpringUtils.bindCustomPropertiesMap(environment, "anordine.completions-api-webflux.custom", WebClientProperties.CustomClient.class);
    }
