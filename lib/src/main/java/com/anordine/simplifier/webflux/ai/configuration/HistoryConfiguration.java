...
import com.anordine.simplifier.webflux.ai.properties.HistoryProperties;
...
public class HistoryConfiguration {
    ...
    private static final String HISTORY_PREFIX = "com.anordine.simplifier.webflux.ai.history";
