...
class CompletionToolRegistryTest {
    ...
    void scansCompletionProviderBeansAfterStartup() {
        try (AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext()) {
            ...
            List<com.anordine.simplifier.webflux.ai.model.tool.abs.CompletionTool> tools = registry.getTools();
    ...
    void exposesToolsByName() {
        try (AnnotationConfigApplicationContext context = registryContext(ToolProvider.class)) {
            ...
            Map<String, com.anordine.simplifier.webflux.ai.model.tool.abs.CompletionTool> toolsByName =
    ...
    void canSelectToolsByName() {
        try (AnnotationConfigApplicationContext context = registryContext(ToolProvider.class)) {
            ...
            List<com.anordine.simplifier.webflux.ai.model.tool.abs.CompletionTool> tools = registry.getTools("second");
